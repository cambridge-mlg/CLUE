...
def train_NN_classification(net, name, batch_size, nb_epochs, trainset, valset, cuda, flat_ims=False,
                            nb_its_dev=1, early_stop=None):
...
def train_NN_regression(net, name, batch_size, nb_epochs, trainset, valset, cuda,
                         flat_ims=False, nb_its_dev=1, y_mu=0, y_std=1, early_stop=None):
